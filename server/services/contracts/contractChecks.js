...
function contractValidity(ctids, uid, mail) {
  ...
  contractOp.find({
    ...
    .then(function(data) {
      ...
      logger.debug("DEBUG: Contracts to remove... " + JSON.stringify(toRemoveCtid));
